    ...
    def forwards(self, orm):
        ...
        db.create_table('test_south_support_gallery_photos', (
            ...
            ('gallery', models.ForeignKey(
                orm['test_south_support.gallery'], null=False)),
            ('photo', models.ForeignKey(
                orm['test_south_support.photo'], null=False)),
            ('sort_value', models.IntegerField())
        ))
        db.create_unique('test_south_support_gallery_photos',
                         ['gallery_id', 'photo_id'])
        ...
        db.create_table('test_south_support_unsortedgallery_photos', (
            ('id', models.AutoField(verbose_name='ID',
                                    primary_key=True, auto_created=True)),
            ('unsortedgallery', models.ForeignKey(
                orm['test_south_support.unsortedgallery'], null=False)),
            ('photo', models.ForeignKey(
                orm['test_south_support.photo'], null=False))
        ))
        db.create_unique('test_south_support_unsortedgallery_photos', [
                         'unsortedgallery_id', 'photo_id'])
