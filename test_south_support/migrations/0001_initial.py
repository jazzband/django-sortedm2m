...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(
            'test_south_support_unsortedgallery',
            (('id',
              self.gf('django.db.models.fields.AutoField')(
                  primary_key=True)),
                ('name',
        ...
        db.create_table(
            'test_south_support_unsortedgallery_photos',
            (('id',
              models.AutoField(
                  verbose_name='ID',
                  primary_key=True,
                ...
                ('unsortedgallery',
                 models.ForeignKey(
                     orm['test_south_support.unsortedgallery'],
                     null=False)),
                ('photo',
                 models.ForeignKey(
                     orm['test_south_support.photo'],
                     null=False))))
        db.create_unique(
            'test_south_support_unsortedgallery_photos', [
