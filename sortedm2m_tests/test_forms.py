...
class SortedForm(forms.Form):
    values = SortedMultipleChoiceField(queryset=Book.objects.all(), required=False)


class SortedNameForm(forms.Form):
    values = SortedMultipleChoiceField(queryset=Book.objects.all(), to_field_name="name")
...
class TestSortedFormField(TestCase):
    ...
    def test_sorted_field_input(self):
        ...
        self.assertEqual(
            ...
            [self.books[3], self.books[1], self.books[8]],
        )
    ...
    def test_for_attribute_in_label(self):
        ...
        rendered = force_text(form["values"])
        self.assertTrue(
            ' for="id_hacking&quot;&gt;&lt;a href=&quot;TRAP&quot;&gt;-values_0"'
            in rendered
        )
    ...
    def test_input_id_is_escaped(self):
        ...
        rendered = force_text(form["values"])
        self.assertTrue(
            ' id="id_hacking&quot;&gt;&lt;a href=&quot;TRAP&quot;&gt;-values_0"'
            in rendered
        )
